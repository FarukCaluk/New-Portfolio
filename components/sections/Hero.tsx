...
import {
  ...
  CherryBlossom,
  RedSun,
} from "@/components/JapaneseElements";
...
const SOCIALS = [
  ...
  {
    icon: FaLinkedinIn,
    href: "https://www.linkedin.com/in/faruk-čaluk-86a52a269/",
    label: "LinkedIn",
  },
  {
    icon: FaInstagram,
    href: "https://www.instagram.com/__faruk18",
    label: "Instagram",
  },
    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(180,60,20,0.18) 0%, rgba(140,40,10,0.08) 45%, transparent 72%)",
          filter: "blur(40px)",
          zIndex: 1,
          pointerEvents: "none",
        }}
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse 90% 80% at 55% 55%, transparent 30%, rgba(9,8,10,0.88) 100%)",
        }}
      />
      ...
      >
        ...
        >
          ...
          >
            &ldquo;改善 · Every line of code is a chance to improve by
            1%.&rdquo;
          </p>
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "3px",
              background:
                "linear-gradient(135deg, var(--gold-light), var(--gold-dark), var(--gold))",
              zIndex: 1,
            }}
          >
            {/* Inner dark ring */}
